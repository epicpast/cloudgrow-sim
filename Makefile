...
help:  ## Show this help message
	@echo '================================'
	@echo 'cloudgrow-sim - Make Targets'
	@echo '================================'
	@echo ''
...
test-cov:  ## Run tests with coverage
	uv run pytest --cov=cloudgrow_sim --cov-report=html --cov-report=term-missing
...
coverage:  ## Run tests with coverage threshold
	uv run pytest --cov=cloudgrow_sim --cov-report=term-missing --cov-fail-under=80
...
quality:  ## Run all quality checks
	...
	@uv run pytest --cov=cloudgrow_sim --cov-report=term-missing --cov-fail-under=80 -q
	@echo ""
